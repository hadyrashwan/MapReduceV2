...
public class IndexReducer extends Reducer<Text, Text, Text, Text> {
	...
	private Text defaultValue = new Text();
  @Override
  public void reduce(Text key, Iterable<Text> values, Context context)
      throws IOException, InterruptedException {

    String conc = "";
    for(Text pathNumber : values)
    {
    	conc += pathNumber.toString();
    	conc += ",";
    }
    defaultValue.set(conc.substring(0, conc.length()-1)); // to remove the extra comma 
    
    context.write(key, defaultValue);

...
//    job.setOutputKeyClass(LongWritable.class); // the output key is Text
//    job.setOutputValueClass(Text.class); // the output key is special type of intger called IntWritable
